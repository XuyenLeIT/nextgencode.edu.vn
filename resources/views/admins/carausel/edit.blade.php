...
@section('content')
    <div class="container">
        ...
        <form method="POST" action="{{ route('admin.carausel.update',$carausel) }}"
             enctype="multipart/form-data">
            @csrf
            <div class="mb-3 mt-3">
                <label for="title" class="form-label">Title:</label>
                <input type="text" class="form-control" 
                value="{{old('title',$carausel->title)}}" placeholder="Enter title" name="title">
                @error('title')
            ...
            <div class="mb-3 mt-3">
                ...
                <div class="form-check">
                    ...
                    <input class="form-check-input" type="checkbox" id="check1"
                       name="status" value="{{old('status',$carausel->status)}}" 
